...
public class GmailService {
	...
	private static final String CREDENTIALS_FILE_PATH = System.getProperty("user.dir") + File.separator + "src"
			+ File.separator + "main" + File.separator + "resources" + File.separator + "credentials.json";

	private static final String TOKENS_DIRECTORY_PATH = System.getProperty("user.dir") + File.separator + "src"
			+ File.separator + "main" + File.separator + "tokens";
	...
	public static HashMap<String, String> searchMail(String query) {
		try {
	...
	//public static void run() throws IOException, GeneralSecurityException {
		/*
		 * HashMap<String, String> hm = searchMail("subject:new link");
		 * System.out.println(hm.get("subject"));
		 * System.out.println("================="); System.out.println(hm.get("body"));
		 * System.out.println("================="); System.out.println(hm.get("link"));
		 * 
		 * System.out.println("=================");
		 * System.out.println("Total count of emails is :" + getTotalCountOfMails());
		 * 
		 * System.out.println("================="); boolean exist =
		 * isMailExist("new link"); System.out.println("title exist or not: " + exist);
		 */
